...
Puedes usar esta opción si la factura eliminada estaba **Pendiente**, **Abonada** o **Vencida**.

### Crear una factura manual

1. Ve a **Clientes**.
2. Abre el perfil del cliente.
3. Selecciona **Más acciones**.
...
* **Fecha de emisión:** el día de corte del cliente durante el mes actual.
* **Fecha de vencimiento:** el día de corte más los días de gracia configurados.

{% hint style="warning" %}
Revisa el historial de facturas antes de confirmar. Evita crear una factura duplicada para el mismo período.
{% endhint %}
